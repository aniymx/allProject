...
<div class="container">
    ...
    <div style="float: right">
        <a class="btn btn-primary" href="javascript:void(0)" id="delSel">删除选中</a>
    ...
    <form action="${pageContext.request.contextPath}/delSelectUserServlet" id="form" method="post">
            ...
            <c:forEach items="${pb.list}" var="user" varStatus="s">
                <tr>
                    ...
                    <td><a class="btn btn-default btn-sm"
                           href="${pageContext.request.contextPath}/updateServlet?id=${user.id}">修改</a>&nbsp;
...
<c:if test="${pb.currentPage==i}">
    ...
    <c:if test="${pb.currentPage!=i}">
        ...
        <span>共${pb.totalCount}条数据,共${pb.totalPage}页</span>
    </ul>
</div>
</body>
</html>
